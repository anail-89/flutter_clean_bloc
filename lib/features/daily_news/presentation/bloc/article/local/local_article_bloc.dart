...
import 'package:flutter_clean_bloc/features/daily_news/domain/usecases/remove_article.dart';
...
class LocalArticleBloc extends Bloc<LocalArticleEvents, LocalArticlesState> {
  ...
  void onGetSavedArticles(GetSavedArticles getArticles, Emitter<LocalArticlesState> emit) async {
